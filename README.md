...
<p align="justify">
I work across modern web development and AI/ML, with a mindset built around structured problem-solving. 
I focus on clarity in architecture, efficiency in execution, and code that’s easy to extend—not just easy to write. 
My goal is to build reliable systems that scale without unnecessary complexity.
</p>
